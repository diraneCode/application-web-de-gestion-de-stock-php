<?php
    ...
    if(isset($_GET['id'])){
      ...
      $query2 = $db->query("SELECT * FROM categorie_article WHERE id = ".$id);
      $libelle_categorie = $query2->fetch(PDO::FETCH_OBJ);

      if(isset($_POST['modifier'])){
          $libelle = $_POST['libelle'];

          $requete = $db->prepare("UPDATE categorie_article SET libelle_categorie = ? WHERE id = ". $id);
            ...
            <div class="col-sm-6">
                <form method="post" action="" class="card p-3 shadow">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                      <h3>Modifier un Catégorie</h3>
                      <a href="index.php?p=categorie" class="btn btn-primary">Retour</a>
                    </div>
                    <div class="form-floating mb-3 rounded">
                        <input type="text" value="<?= $libelle_categorie->libelle_categorie ?>" name="libelle" id="libelle" class="form-control" placeholder="Entrez le libelle" required>
