<?php
  ...
  if(isset($_GET['id'])){
    ...
    if(isset($_POST['delete'])){
      ...
      try{
        $req = $db->query("DELETE FROM client WHERE id = ". $idClient);
        header('location: index.php?p=client');
      }catch(PDOException $e){
        echo '
          <div class="alert alert-danger">
            Vous ne pouvez pas supprimer ce client car il est utilisé dans plusieurs commandes ou ventes
          </div>
        ';
      }
    }
        ...
        <div class="row p-3">
            ...
            <div class="col-sm-8">
                <div class="alert alert-danger d-flex flex-column justify-content-between align-items-center">
                    <h4 class="h4 text-black">Voulez-vous vraiment supprimer ce client ?</h4>
                    <form action="" method="post">
                      <input type="hidden" name="idClient" value="<?= $id ?>">
                      <a href="index.php?p=client" class="btn btn-primary">NON</a>
