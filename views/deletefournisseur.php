<?php
  ...
  if(isset($_GET['id'])){
    ...
    if(isset($_POST['delete'])){
      ...
      $req = $db->query("DELETE FROM fournisseur WHERE id = ". $idCategorie);
  ...
  <body>
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="index.php?p=fournisseur" class="active">
        ...
        <div class="row p-3">
            ...
            <div class="col-sm-8">
                <div class="alert alert-danger d-flex flex-column justify-content-between align-items-center">
                    <h4 class="h4 text-black">Voulez-vous vraiment supprimer ce fournisseur ?</h4>
                    <form action="" method="post">
                      <input type="hidden" name="idCategorie" value="<?= $id ?>">
                      <a href="index.php?p=fournisseur" class="btn btn-primary">NON</a>
