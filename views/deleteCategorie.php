<?php
  ...
  if(isset($_GET['id'])){
    ...
    if(isset($_POST['delete'])){
      ...
      $req = $db->query("DELETE FROM categorie_article WHERE id = ". $idCategorie);
        ...
        <div class="row p-3">
            ...
            <div class="col-sm-8">
                <div class="alert alert-danger d-flex flex-column justify-content-between align-items-center">
                    <h4 class="h4 text-black">Voulez-vous vraiment supprimer cette catégorie ?</h4>
                    <form action="" method="post">
                      <input type="hidden" name="idCategorie" value="<?= $id ?>">
                      <a href="index.php?p=categorie" class="btn btn-primary">NON</a>
